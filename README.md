...
![Gambar 3.1 Cloudword](path/to/image)
...
#### TextBlob
![Gambar 3.5 Distribusi sentimen IKN (TextBlob)](path/to/image)
...
#### Naive Bayes
![Gambar 3.6 Distribusi sentimen IKN (Naive Bayes)](path/to/image)
